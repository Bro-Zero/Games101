...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "D:/Project/C/Project/Project/models/spot/";

    // Load .obj File
    bool loadout = Loader.LoadFile("D:/Project/C/Project/Project/models/spot/spot_triangulated_good.obj");
