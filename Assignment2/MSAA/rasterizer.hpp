...
namespace rst
{
    ...
    public:
        ...
        void set_pixel_SSAA(const Eigen::Vector3f& point, int x_SSAA, int y_SSAA, const Eigen::Vector3f& color);
    ...
    private:
        ...
        int get_index_SSAA(int x, int y, int x_SSAA, int y_SSAA);
        int get_index_MSAA(int x, int y, int x_MSAA, int y_MSAA);
